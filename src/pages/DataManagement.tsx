...
const serviceSchema = {
  ...
  description: "Full clinical data management services including EDC, CDISC/SDTM compliance, database design, and real-world registry expertise.",
  areaServed: "Worldwide",
  serviceType: "Clinical Data Management",
};

const DataManagement = () => (
  <>
    <SEOHead
      title="Clinical Data Management | Datametrix AG"
      description="End-to-end clinical data management — EDC systems, CDISC/SDTM compliance, database design & real-world registry expertise since 2003."
